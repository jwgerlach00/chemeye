...
class TestTsne(unittest.TestCase):
    ...
    def test_sim_matrix(self):
        mat_maccs = tsne.sim_matrix(self.maccs_keys, self.maccs_keys, key_type='maccs')  # Test MACCS keys
        mat_ecfp4 = tsne.sim_matrix(self.ecfp4_prints, self.ecfp4_prints)  # Test ECFP4
        mat_ecfp6 = tsne.sim_matrix(self.ecfp6_prints, self.ecfp6_prints)  # Test ECFP6
